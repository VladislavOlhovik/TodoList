import { AddTodolistAC, ChangeTodolistTitleAC, RemoveTodolistAC, todolistsReducer, ChangeTodolistFilterAC, TodolistDomainType, filtersValueType, SetTodolistAC, changeTodolistEntityStatusAC } from './todolists-reducer';
import {v1} from 'uuid';
...
test('correct entity status of todolist should be changed', () => {
  ...
  const action = changeTodolistEntityStatusAC({ entityStatus: newStatus, todolistId: todolistId2 })
